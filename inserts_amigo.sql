...
VALUES
('PROF001', 'Carmen', 'Salazar Deza', 'InglǸs'),
('PROF002', 'Cesar Gerardo', 'Leon Velarde', 'Lenguaje y Comunicaci�n'),
('PROF003', 'Oscar Hugo', 'Mujica Ruiz', 'Metodolog�a'),
('PROF004', 'Jorge Alberto', 'Vales Carrillo', 'Matemǭtica'),
('PROF005', 'Jorge Victor', 'Mayhuasca Guerra', 'Ingenier�a de Sistemas'),
('PROF006', 'Noemi', 'Ramirez Saavedra', 'Estad�stica'),
('PROF007', 'Heddy', 'Colca Garcia', 'Sistemas'),
('PROF008', 'Pablo R.', 'Aparicio Montenegro', 'Estad�stica y Programaci�n'),
('PROF009', 'Manuel', 'Narro Andrade', 'Sistemas'),
('PROF010', 'Armando Ricardo', 'Huapaya Sotero', 'Programaci�n'),
('PROF011', 'Jose Orlando', 'Alvarado Alvarado', 'Ingenier�a de Sistemas'),
...
('PROF016', 'Ivan Carlo', 'Petrlik Azabache', 'Programaci�n'),
('PROF017', 'Luis', 'Soto Soto', 'Bases de Datos'),
('PROF018', 'Luis Avelino', 'Mu�oz Ramos', 'Procesos de Negocios'),
...
('PROF029', 'Orestes', 'Cachay Boza', 'Investigaci�n'),
('PROF030', 'Rogelio G.', 'Cohello Aguirre', 'Programaci�n'),
...
('PROF034', 'Jaime Demetrio', 'Cano Espada', 'Matemǭtica'),
('PROF035', 'Lucio', 'Jara Bautista', 'Ingenier�a Industrial'),
('PROF036', 'Heriberto Reginaldo', 'Magallanes Villaverde', 'F�sica'),
('PROF037', 'Fernando', 'Hernǭndez Conde', 'Ingenier�a Industrial')
...
('P10-031', 'ANALISIS Y DISE�'O DE SISTEMAS DE INFORMACION', 4, '8B0110'),
...
-- Geopol�tica y Realidad Nacional
...
-- Fundamentos de Programaci�n II
...
-- Ingenier�a de Costos y Presupuestos
...
-- Ingenier�a de Procesos de Negocios
...
-- Administraci�n y Gesti�n de Base de Datos
